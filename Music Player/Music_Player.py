...
class MusicPlayer:
    def __init__(self, root):
        ...
        # Create track label
        self.track_label = tk.Label(root, textvariable=self.current_track, font=("Helvetica", 20))
        ...
        # Create status label
        self.status_label = tk.Label(root, textvariable=self.status, font=("Helvetica", 15))
